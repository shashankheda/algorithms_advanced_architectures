...
#include "fft_parallel.c.opari.inc"
#line 1 "fft_parallel.c"
/************************************************
...
POMP_For_exit(&omp_rd_28);
POMP_Parallel_end(&omp_rd_28); }
POMP_Parallel_join(&omp_rd_28);
#line 143 "fft_parallel.c"

	/* calculate FFT */
	four1(X, NFFT, 1);

	printf("\nFFT:\n");
POMP_Parallel_fork(&omp_rd_29);
#line 148 "fft_parallel.c"
	#pragma omp parallel    
{ POMP_Parallel_begin(&omp_rd_29);
...
POMP_Parallel_end(&omp_rd_29); }
POMP_Parallel_join(&omp_rd_29);
#line 153 "fft_parallel.c"
...
#line 158 "fft_parallel.c"
	#pragma omp parallel    
{ POMP_Parallel_begin(&omp_rd_30);
POMP_For_enter(&omp_rd_30);
#line 158 "fft_parallel.c"
 #pragma omp          for nowait
	for(i=0; i<NFFT; i++)
	{
...
POMP_For_exit(&omp_rd_30);
POMP_Parallel_end(&omp_rd_30); }
POMP_Parallel_join(&omp_rd_30);
#line 164 "fft_parallel.c"

	printf("\nComplex sequence reconstructed by IFFT:\n");
POMP_Parallel_fork(&omp_rd_31);
#line 166 "fft_parallel.c"
	#pragma omp parallel    
{ POMP_Parallel_begin(&omp_rd_31);
